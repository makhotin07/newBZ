...
Модуль: ui-kit
Inventory (кратко): базовые UI компоненты есть, но без поддержки a11y, reduced motion, современных возможностей
Target: UI-kit 2025 с поддержкой a11y, reduced motion, современными вариантами и тестами
Changes: frontend/src/shared/ui/Button.tsx - улучшен с новыми вариантами и a11y, frontend/src/shared/ui/Input.tsx - улучшен с новыми возможностями, frontend/src/shared/ui/Textarea.tsx - создан новый компонент, frontend/src/shared/ui/Button.test.tsx - обновлены тесты, frontend/src/shared/ui/Textarea.test.tsx - созданы тесты, frontend/src/shared/ui/index.ts - обновлены экспорты
Checks: pnpm lint/typecheck/test - ✅ OK, pytest - не применимо, rg по старым путям - не применимо
Changelog: commit 33de3b7 - feat(ui-kit): P0-40 - улучшение UI-kit 2025 с поддержкой a11y и reduced motion
