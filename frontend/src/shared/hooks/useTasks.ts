...
import { tasksApi, CreateTaskBoardData, UpdateTaskBoardData, CreateTaskData, UpdateTaskData, CreateTaskColumnData } from '../../features/tasks/api';
...
export const useMoveTask = (boardId: string) => {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: { column: string; position: number } }) =>
