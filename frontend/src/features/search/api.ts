...
export const searchApi = {
  ...
  // Global search
  globalSearch: async (query: string, search_type?: string, page?: number, page_size?: number): Promise<SearchResponse> => {
  ...
  // Workspace search
  workspaceSearch: async (workspace_id: string, query: string, search_type?: string, page?: number, page_size?: number): Promise<SearchResponse> => {
    const response = await api.get(`/search/workspace/${workspace_id}/`, {
      params: {
        q: query,
        type: search_type,
        page,
  ...
  addToHistory: async (data: { query: string; search_type?: string; filters?: SearchFilters; workspace_id?: string }): Promise<void> => {
