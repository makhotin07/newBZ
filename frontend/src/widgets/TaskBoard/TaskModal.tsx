...
import { UpdateTaskData } from '../../features/tasks/api';
  ...
  useEffect(() => {
    if (task) {
      setFormData({
        ...
        tag_ids: task.tags.map((t: any) => t.id),
      });
    }
  }, [task]);
                  ...
                  <div className="flex-1 p-6">
                    ...
                    {isEditing ? (
                      <input
                        ...
                        onChange={(e) => setFormData((prev: UpdateTaskData) => ({ ...prev, title: e.target.value }))}
                    ...
                    <div className="mb-6">
                      ...
                      {isEditing ? (
                        <textarea
                          ...
                          onChange={(e) => setFormData((prev: UpdateTaskData) => ({ ...prev, description: e.target.value }))}
                            ...
                            <div>
                              ...
                              {isEditing ? (
                                <TagSelector
                                  ...
                                  onChange={(tagIds) => setFormData((prev: UpdateTaskData) => ({ ...prev, tag_ids: tagIds }))}
                                />
                              ) : (
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            <select
                              ...
                              onChange={(e) => setFormData((prev: UpdateTaskData) => ({ ...prev, status: e.target.value as any }))}
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            <select
                              ...
                              onChange={(e) => setFormData((prev: UpdateTaskData) => ({ ...prev, priority: e.target.value as any }))}
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                            >
                          ...
                          <div>
                            ...
                            {isEditing ? (
                              <input
                                ...
                                onChange={(e) => setFormData((prev: UpdateTaskData) => ({ ...prev, start_date: e.target.value }))}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                              />
                            ) : (
                          ...
                          <div>
                            ...
                            {isEditing ? (
                              <input
                                ...
                                onChange={(e) => setFormData((prev: UpdateTaskData) => ({ ...prev, due_date: e.target.value }))}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                              />
                            ) : (
                        ...
                        {isEditing ? (
                          <input
                            ...
                            value={formData.estimated_hours || ''}
                                                        onChange={(e) => setFormData((prev: UpdateTaskData) => ({ 
                              ...prev, 
